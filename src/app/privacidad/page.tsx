const PrivacyPage = () => {
  return (
    <div className="min-h-screen bg-neutral-100 py-12 px-4">
      <div className="max-w-2xl mx-auto bg-white border border-neutral-200 rounded-xl shadow-sm p-8">
        ...
        <div className="text-sm text-neutral-600 leading-relaxed space-y-4">
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Responsable del tratamiento</h2>
          <p>
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Finalidad del tratamiento</h2>
          <p>
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Legitimación</h2>
          <p>
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Destinatarios</h2>
          <p>
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Derechos del usuario</h2>
          <p>
          ...
          <h2 className="text-base font-semibold text-neutral-950 mt-6">Plazo de conservación</h2>
          <p>
