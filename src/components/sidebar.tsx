...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-[72px] left-0 bottom-0 w-[250px] z-50 bg-neutral-100 dark:bg-neutral-950 p-4 pl-3 border-r border-neutral-200 dark:border-neutral-800 transition-transform duration-200 lg:hidden ${
